...
# Dicionário de Layout (Posições oficiais do SIGTAP para as suas 8 tabelas)
# Formato: (Início, Fim) - Base zero
LAYOUTS = {
    'tb_procedimento.txt': {
...
def download_sigtap():
    ...
    if res.status_code != 200:
        print(f"Competência {comp} ainda não disponível. Tentando mês anterior...")
        # Lógica para tentar o mês anterior se o atual não existir
        return None 
